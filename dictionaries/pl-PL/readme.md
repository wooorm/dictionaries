...
Polish (Poland) spelling dictionary in UTF-8.
...
Dictionary and affix file: [(GPL-3.0 OR LGPL-3.0 OR MPL-2.0)](https://github.com/wooorm/dictionaries/blob/master/dictionaries/pl-PL/LICENSE).
