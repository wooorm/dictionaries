...
This is a English (Canada) dictionary,
...
```js
import enCa from 'dictionary-en-ca'

console.log(enCa)
// To do: use `enCa` somehow
```
...
[(MIT AND BSD)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/en-CA/license).
