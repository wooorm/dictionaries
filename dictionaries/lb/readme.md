...
Luxembourgish spelling dictionary.

## What is this?

This is a Luxembourgish dictionary,
...
```js
import dictionaryLb from 'dictionary-lb'

dictionaryLb(function (error, lb) {
  if (error) throw error
  console.log(lb)
  // To do: use `lb` somehow
})
```
...
> Report spelling problems upstream ([`spellchecker-lu/dictionary-lb-lu`][source]).
