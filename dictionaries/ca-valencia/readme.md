...
Catalan (Valencia) spelling dictionary.
...
This is a Catalan (Valencia) dictionary,
...
```js
import caValencia from 'dictionary-ca-valencia'
...
[(GPL-2.0 OR LGPL-2.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/ca-valencia/license).
