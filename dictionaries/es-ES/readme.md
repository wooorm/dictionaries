...
Spanish (or Castilian, Spain) spelling dictionary in UTF-8.
...
```bash
npm install dictionary-es-es
```

## Usage

```js
var esES = require('dictionary-es-es')

esES(function (err, result) {
...
var base = require.resolve('dictionary-es-es')
