...
Generated by [`dictionaries`][dictionaries] via extraction &
encoding conversion of [`addons.mozilla.org`][source1] instead of [`j3e.de`][source2].
...
[source1]: https://addons.mozilla.org/firefox/addon/german-dictionary-de_de-for-sp/

[source2]: https://www.j3e.de/ispell/igerman98/index_en.html
