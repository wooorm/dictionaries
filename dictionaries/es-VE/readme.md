...
Spanish (Venezuela) spelling dictionary.
...
This is a Spanish (Venezuela) dictionary,
...
```js
import esVe from 'dictionary-es-ve'

console.log(esVe)
// To do: use `esVe` somehow
```
...
[(GPL-3.0 OR LGPL-3.0 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/es-VE/license).
