...
Irish spelling dictionary.

## What is this?

This is a Irish dictionary,
...
```js
import dictionaryGa from 'dictionary-ga'

dictionaryGa(function (error, ga) {
  if (error) throw error
  console.log(ga)
  // To do: use `ga` somehow
})
```
...
> Report spelling problems upstream ([`kscanne/gaelspell`][source]).
