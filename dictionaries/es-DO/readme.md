...
Spanish (Dominican Republic) spelling dictionary.
...
This is a Spanish (Dominican Republic) dictionary,
...
```js
import esDo from 'dictionary-es-do'

console.log(esDo)
// To do: use `esDo` somehow
```
...
[(GPL-3.0 OR LGPL-3.0 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/es-DO/license).
