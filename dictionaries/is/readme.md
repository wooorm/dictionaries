...
This is a Icelandic dictionary,
...
```js
import is from 'dictionary-is'

console.log(is)
// To do: use `is` somehow
```
...
[CC-BY-SA-3.0](https://github.com/wooorm/dictionaries/blob/main/dictionaries/is/license).
