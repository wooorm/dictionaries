...
Low German spelling dictionary.

## What is this?

This is a Low German dictionary,
...
```js
import dictionaryNds from 'dictionary-nds'

dictionaryNds(function (error, nds) {
  if (error) throw error
  console.log(nds)
  // To do: use `nds` somehow
})
```
...
> Report spelling problems upstream ([`tdf/dict_nds`][source]).
