...
```js
import ne from 'dictionary-ne'

console.log(ne)
// To do: use `ne` somehow
```
...
[LGPL-2.1](https://github.com/wooorm/dictionaries/blob/main/dictionaries/ne/license).
