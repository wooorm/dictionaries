...
Spanish (Uruguay) spelling dictionary.
...
This is a Spanish (Uruguay) dictionary,
...
```js
import esUy from 'dictionary-es-uy'

console.log(esUy)
// To do: use `esUy` somehow
```
...
[(GPL-3.0 OR LGPL-3.0 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/es-UY/license).
