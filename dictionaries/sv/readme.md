...
```js
import sv from 'dictionary-sv'

console.log(sv)
// To do: use `sv` somehow
```
...
[LGPL-3.0](https://github.com/wooorm/dictionaries/blob/main/dictionaries/sv/license).
