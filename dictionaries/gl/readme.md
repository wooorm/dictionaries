...
```js
import dictionaryGl from 'dictionary-gl'

dictionaryGl(function (error, gl) {
  if (error) throw error
  console.log(gl)
  // To do: use `gl` somehow
})
```
...
> Report spelling problems upstream ([`meixome/hunspell-gl`][source]).
