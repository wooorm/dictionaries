...
Interlingue spelling dictionary.

## What is this?

This is a Interlingue dictionary,
...
```js
import dictionaryIe from 'dictionary-ie'

dictionaryIe(function (error, ie) {
  if (error) throw error
  console.log(ie)
  // To do: use `ie` somehow
})
```
...
> Report spelling problems upstream ([`Carmina16/hunspell-ie`][source]).
