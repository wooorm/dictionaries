...
Croatian spelling dictionary.

## What is this?

This is a Croatian dictionary,
...
```js
import dictionaryHr from 'dictionary-hr'

dictionaryHr(function (error, hr) {
  if (error) throw error
  console.log(hr)
  // To do: use `hr` somehow
})
```
...
> Report spelling problems upstream ([`krunose/hunspell-hr`][source]).
