...
Latgalian spelling dictionary.

## What is this?

This is a Latgalian dictionary,
...
```js
import dictionaryLtg from 'dictionary-ltg'

dictionaryLtg(function (error, ltg) {
  if (error) throw error
  console.log(ltg)
  // To do: use `ltg` somehow
})
```
...
> Report spelling problems upstream ([`dict.dv.lv`][source]).
