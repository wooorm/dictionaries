...
Spanish (Panama) spelling dictionary.
...
This is a Spanish (Panama) dictionary,
...
```js
import esPa from 'dictionary-es-pa'

console.log(esPa)
// To do: use `esPa` somehow
```
...
[(GPL-3.0 OR LGPL-3.0 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/es-PA/license).
