...
Italian (Italy) spelling dictionary in UTF-8.
...
Dictionary and affix file: [GPL-3.0](https://github.com/wooorm/dictionaries/blob/master/dictionaries/it_IT/LICENSE). Rest: MIT ©
[Titus Wormer][home].
...
[source]: http://extensions.openoffice.org/en/project/italian-dictionary-thesaurus-hyphenation-patterns
