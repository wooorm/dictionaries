...
> Report spelling problems upstream ([`375gnu/hunspell-be`][source]).

## License

Dictionary and affix file: [CC-BY-SA-3.0](https://github.com/wooorm/dictionaries/blob/main/dictionaries/be/license).
...
[source]: https://github.com/375gnu/hunspell-be
