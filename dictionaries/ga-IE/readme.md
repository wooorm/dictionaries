...
Irish (Ireland) spelling dictionary in UTF-8.
...
```bash
npm install dictionary-ga-ie
```

## Usage

```js
var gaIE = require('dictionary-ga-ie');

gaIE(function (err, result) {
...
var base = require.resolve('dictionary-ga-ie');
...
Dictionary and affix file: [GPL-2.0](https://github.com/wooorm/dictionaries/blob/master/dictionaries/ga-IE/LICENSE).
