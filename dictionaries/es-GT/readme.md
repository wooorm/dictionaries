...
Spanish (Guatemala) spelling dictionary.
...
This is a Spanish (Guatemala) dictionary,
...
```js
import esGt from 'dictionary-es-gt'

console.log(esGt)
// To do: use `esGt` somehow
```
...
[(GPL-3.0 OR LGPL-3.0 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/es-GT/license).
