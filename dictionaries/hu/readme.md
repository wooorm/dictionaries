...
This is a Hungarian dictionary,
...
```js
import hu from 'dictionary-hu'

console.log(hu)
// To do: use `hu` somehow
```
...
[(GPL-2.0 OR LGPL-2.1 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/hu/license).
