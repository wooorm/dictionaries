...
Georgian spelling dictionary.

## What is this?

This is a Georgian dictionary,
...
```js
import dictionaryKa from 'dictionary-ka'

dictionaryKa(function (error, ka) {
  if (error) throw error
  console.log(ka)
  // To do: use `ka` somehow
})
```
...
> Report spelling problems upstream ([`gamag/ka_GE.spell`][source]).
