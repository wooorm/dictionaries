...
```js
import ca from 'dictionary-ca'

console.log(ca)
// To do: use `ca` somehow
```
...
[(GPL-2.0 OR LGPL-2.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/ca/license).
