...
Spanish (Ecuador) spelling dictionary.
...
This is a Spanish (Ecuador) dictionary,
...
```js
import esEc from 'dictionary-es-ec'

console.log(esEc)
// To do: use `esEc` somehow
```
...
[(GPL-3.0 OR LGPL-3.0 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/es-EC/license).
