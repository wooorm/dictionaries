...
Spanish (Honduras) spelling dictionary.
...
This is a Spanish (Honduras) dictionary,
...
```js
import esHn from 'dictionary-es-hn'

console.log(esHn)
// To do: use `esHn` somehow
```
...
[(GPL-3.0 OR LGPL-3.0 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/es-HN/license).
