...
Russian (Russian Federation) spelling dictionary in UTF-8.
...
Dictionary and affix file: [BSD-2-Clause](https://github.com/wooorm/dictionaries/blob/master/dictionaries/ru-RU/LICENSE).
