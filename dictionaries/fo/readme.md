...
```js
import fo from 'dictionary-fo'

console.log(fo)
// To do: use `fo` somehow
```
...
[(GPL-2.0 OR LGPL-2.1 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/fo/license).
