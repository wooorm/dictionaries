...
Kinyarwanda (Rwanda) spelling dictionary in UTF-8.
...
Dictionary and affix file: [GPL-3.0](https://github.com/wooorm/dictionaries/blob/master/dictionaries/rw-RW/LICENSE).
