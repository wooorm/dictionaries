...
Klingon (or tlhIngan-Hol, Latin) spelling dictionary in UTF-8.
...
Dictionary and affix file: [Apache-2.0](https://github.com/wooorm/dictionaries/blob/master/dictionaries/tlh-Latn/license).
