...
Klingon (Latin script) spelling dictionary.
...
This is a Klingon (Latin script) dictionary,
...
```js
import tlhLatn from 'dictionary-tlh-latn'
...
[Apache-2.0](https://github.com/wooorm/dictionaries/blob/main/dictionaries/tlh-Latn/license).
