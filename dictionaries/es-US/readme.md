...
Spanish (United States of America) spelling dictionary.
...
This is a Spanish (United States of America) dictionary,
...
```js
import esUs from 'dictionary-es-us'

console.log(esUs)
// To do: use `esUs` somehow
```
...
[(GPL-3.0 OR LGPL-3.0 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/es-US/license).
