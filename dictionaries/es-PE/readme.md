...
Spanish (Peru) spelling dictionary.
...
This is a Spanish (Peru) dictionary,
...
```js
import esPe from 'dictionary-es-pe'

console.log(esPe)
// To do: use `esPe` somehow
```
...
[(GPL-3.0 OR LGPL-3.0 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/es-PE/license).
