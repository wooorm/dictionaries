...
Spanish (Paraguay) spelling dictionary.
...
This is a Spanish (Paraguay) dictionary,
...
```js
import esPy from 'dictionary-es-py'

console.log(esPy)
// To do: use `esPy` somehow
```
...
[(GPL-3.0 OR LGPL-3.0 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/es-PY/license).
