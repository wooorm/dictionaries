...
Welsh spelling dictionary.

## What is this?

This is a Welsh dictionary,
generated by [`wooorm/dictionaries`][dictionaries] from
[`techiaith/hunspell-cy`][source],
...
```sh
npm install dictionary-cy
```

## Use

```js
import dictionaryCy from 'dictionary-cy'

dictionaryCy(function (error, cy) {
  if (error) throw error
  console.log(cy)
  // To do: use `cy` somehow
})
```
...
> Report spelling problems upstream ([`techiaith/hunspell-cy`][source]).

## License

Dictionary and affix file: [LGPL-3.0](https://github.com/wooorm/dictionaries/blob/main/dictionaries/cy/license).
