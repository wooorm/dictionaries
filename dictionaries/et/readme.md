...
Estonian spelling dictionary.

## What is this?

This is a Estonian dictionary,
...
```js
import dictionaryEt from 'dictionary-et'

dictionaryEt(function (error, et) {
  if (error) throw error
  console.log(et)
  // To do: use `et` somehow
})
```
...
> Report spelling problems upstream ([`meso.ee`][source]).
