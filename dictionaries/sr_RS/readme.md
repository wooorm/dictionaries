...
Serbian (Serbia) spelling dictionary in UTF-8.
...
```bash
npm install dictionary-sr-rs
```

## Usage

```js
var srRS = require('dictionary-sr-rs');

srRS(function (err, result) {
    if (err) throw err;
...
var base = require.resolve('dictionary-sr-rs');
...
[license]: https://github.com/wooorm/dictionaries/blob/master/dictionaries/sr_RS/LICENSE
