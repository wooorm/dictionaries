...
Spanish (Bolivia) spelling dictionary.
...
This is a Spanish (Bolivia) dictionary,
...
```js
import esBo from 'dictionary-es-bo'

console.log(esBo)
// To do: use `esBo` somehow
```
...
[(GPL-3.0 OR LGPL-3.0 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/es-BO/license).
