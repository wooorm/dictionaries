...
Western Frisian spelling dictionary.

## What is this?

This is a Western Frisian dictionary,
...
```js
import dictionaryFy from 'dictionary-fy'

dictionaryFy(function (error, fy) {
  if (error) throw error
  console.log(fy)
  // To do: use `fy` somehow
})
```
...
> Report spelling problems upstream ([`PanderMusubi/frisian`][source]).
