...
Czech spelling dictionary.

## What is this?

This is a Czech dictionary,
generated by [`wooorm/dictionaries`][dictionaries] from
[`translatoblog.cz`][source],
...
```js
import dictionaryCs from 'dictionary-cs'

dictionaryCs(function (error, cs) {
  if (error) throw error
  console.log(cs)
  // To do: use `cs` somehow
})
```
...
> Report spelling problems upstream ([`translatoblog.cz`][source]).
...
[source]: http://www.translatoblog.cz/hunspell/
