...
Slovak (Slovakia) spelling dictionary in UTF-8.
...
Dictionary and affix file: [GPL-2.0](https://github.com/wooorm/dictionaries/blob/master/dictionaries/sk_SK/LICENSE).  Rest: MIT ©
[Titus Wormer][home].
...
[source]: http://extensions.openoffice.org/en/project/slovak-dictionary-package-slovenske-slovniky
