...
Western Armenian spelling dictionary.
...
This is a Western Armenian dictionary,
...
```js
import hyw from 'dictionary-hyw'

console.log(hyw)
// To do: use `hyw` somehow
```
...
[(GPL-2.0 OR LGPL-2.1 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/hyw/license).
...
[source]: https://extensions.openoffice.org/project/westernarmenian
