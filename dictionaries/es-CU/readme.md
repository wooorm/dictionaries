...
Spanish (Cuba) spelling dictionary.
...
This is a Spanish (Cuba) dictionary,
...
```js
import esCu from 'dictionary-es-cu'

console.log(esCu)
// To do: use `esCu` somehow
```
...
[(GPL-3.0 OR LGPL-3.0 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/es-CU/license).
