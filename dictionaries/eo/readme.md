...
Esperanto spelling dictionary.

## What is this?

This is a Esperanto dictionary,
...
```js
import dictionaryEo from 'dictionary-eo'

dictionaryEo(function (error, eo) {
  if (error) throw error
  console.log(eo)
  // To do: use `eo` somehow
})
```
...
> Report spelling problems upstream ([`esperantilo.org`][source]).
