# dictionary-hy-arevmda

Armenian (Western Armenian) spelling dictionary in UTF-8.
...
```bash
npm install dictionary-hy-arevmda
```

## Usage

```js
var hyArevmda = require('dictionary-hy-arevmda')

hyArevmda(function (err, result) {
...
var base = require.resolve('dictionary-hy-arevmda')
...
Dictionary and affix file: [(GPL-2.0 OR LGPL-2.1 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/master/dictionaries/hy-arevmda/LICENSE).
