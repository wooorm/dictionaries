...
```js
var cyGb = require('dictionary-cy-gb')

cyGb(function (err, result) {
...
Dictionary and affix file: [LGPL-3.0](https://github.com/wooorm/dictionaries/blob/main/dictionaries/cy-GB/license).
