...
This is a Spanish (Argentina) dictionary,
...
```js
import esAr from 'dictionary-es-ar'

console.log(esAr)
// To do: use `esAr` somehow
```
...
[(GPL-3.0 OR LGPL-3.0 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/es-AR/license).
