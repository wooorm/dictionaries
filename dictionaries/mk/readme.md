...
Macedonian spelling dictionary.
...
This is a Macedonian dictionary,
...
```js
import mk from 'dictionary-mk'

console.log(mk)
// To do: use `mk` somehow
```
...
[GPL-3.0](https://github.com/wooorm/dictionaries/blob/main/dictionaries/mk/license).
