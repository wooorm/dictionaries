...
Spanish (Costa Rica) spelling dictionary.
...
This is a Spanish (Costa Rica) dictionary,
...
```js
import esCr from 'dictionary-es-cr'

console.log(esCr)
// To do: use `esCr` somehow
```
...
[(GPL-3.0 OR LGPL-3.0 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/es-CR/license).
